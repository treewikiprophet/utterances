parcelRequire = function(e) {
    ...
    function D() {
        return aa(this, void 0, Promise, function() {
            ...
            return ba(this, function(n) {
                switch (n.label) {
                    case 0:
                        return c.value ? [2, c.value] : (e = p + "/token", [4, fetch(e, {
                            method: "POST",
                            mode: "cors",
                            credentials: "include"
                        })]);
    ...
    b.readRelNext = ha, b.loadJsonFile = J, b.loadIssueByTerm = K, b.loadIssueByNumber = L, b.loadCommentsPage = w, b.loadUser = M, b.createIssue = N, b.postComment = O, b.toggleReaction = P, b.renderMarkdown = Q;
    ...
    e.reactionEmoji = R, e.getReactionHtml = z, e.enableReactions = S, e.getReactionsMenuHtml = A, e.getSignInToReactMenuHtml = B;
        ...
        ua = function() {
            function e(e, r, t) {
                ...
                var n = e.user,
                    ...
                    c = e.reactions;
                this.element = document.createElement("article"), this.element.classList.add("timeline-comment"), n.login === r && this.element.classList.add("current-user");
                var l = ta[s],
                ...
                if (p) {
                    ...
                    p.onclick = function(e) {
                        e.preventDefault(), h.classList.toggle("expanded")
                    }
                }
                U(d)
            }
            ...
            function t(t, e) {
                ...
                this.user = t, this.submit = e, this.submitting = !1, this.renderTimeout = 0, this.handleInput = function() {
                    ...
                    var t = n.textarea.value,
                        e = /^\s*$/.test(t);
                    n.submitButton.disabled = e, n.textarea.scrollHeight < 450 && n.textarea.offsetHeight < n.textarea.scrollHeight && (n.textarea.style.height = n.textarea.scrollHeight + "px", d()), clearTimeout(n.renderTimeout), e ? n.preview.textContent = u : (n.preview.textContent = "Loading preview...", n.renderTimeout = setTimeout(function() {
                    ...
                    if (e instanceof HTMLButtonElement && e.classList.contains("tabnav-tab") && "true" !== e.getAttribute("aria-selected")) {
                        ...
                        n.textarea.style.display = r ? "none" : "", n.preview.style.display = r ? "" : "none", d()
                    }
            ...
            return y(this, function(l) {
                switch (l.label) {
                    case 0:
                        ...
                        }, n = Math.ceil(e.comments / q), o = [w(e.number, 1)], n > 1 && o.push(w(e.number, n)), n > 2 && e.comments % q < 3 && o.push(w(e.number, n - 1)), [4, Promise.all(o)];
                    case 1:
                                ...
                                s = r.insertPageLoader(o, $ * q, function() {
                                    return x(c, void 0, void 0, function() {
                                        ...
                                        return y(this, function(n) {
                                            switch (n.label) {
                                                case 0:
                                                    return s.setBusy(), [4, w(e.number, f)];
                                                case 1:
