parcelRequire = function(e) {
    ...
    function $() {
        ...
        if ("issue-term"in e) {
            if (void 0 !== (r = e["issue-term"])) {
                ...
                if (-1 !== ["title", "url", "pathname", "og:title"].indexOf(r)) {
                    if (!e[r])
                        throw new Error("Unable to find \"" + r + "\" metadata.");
                    r = e[r]
                }
            }
        } else {
            if (!("issue-number"in e))
                throw new Error("\"issue-term\" or \"issue-number\" must be specified.");
            if ((i = +e["issue-number"]).toString(10) !== e["issue-number"])
                throw new Error("issue-number is invalid. \"" + e["issue-number"])
        }
        if (!("repo"in e))
        ...
        var t = _.exec(e.repo);
        if (null === t)
            throw new Error("Invalid repo: \"" + e.repo + "\"");
    ...
    function D() {
        return aa(this, void 0, Promise, function() {
            ...
            return ba(this, function(n) {
                switch (n.label) {
                case 0:
                    return c.value ? [2, c.value] : (e = p + "/token",
                    [4, fetch(e, {
                        method: "POST",
                        mode: "cors",
                        credentials: "include"
    ...
    var da = b && b.__awaiter || function(n, e, t, r) {
            ...
            return function(s) {
                return function(o) {
                    ...
                    for (; a; )
                        try {
                            if (t = 1,
                            r && ($ = 2 & o[0] ? r.return : o[0] ? r.throw || (($ = r.return) && $.call(r),
                            0) : r.next) && !($ = $.call(r, o[1])).done)
                                return $;
                            switch (r = 0,
                            $ && (o = [2 & o[0], $.value]),
                            o[0]) {
      ...
      , E = "https://treewikiprophet.github.io/utterances"
      ...
      , q = 25;
    b.PAGE_SIZE = q;
    var i, j, v = ["+1", "-1", "laugh", "hooray", "confused", "heart", "rocket", "eyes"];
    b.reactionTypes = v;
    var G = "master";
    function H(n) {
        i = n.owner,
    ...
    function h(n, e) {
        ...
        return t.headers.set("Accept", m),
        /^search\//.test(n) || null === c.value || t.headers.set("Authorization", "token " + c.value),
        t
    }
    b.setRepoContext = H;
    var I = {
    ...
    function J(n, e) {
        ...
        return e && t.headers.set("accept", fa),
        f(t).then(function(t) {
            if (404 === t.status)
                throw new Error("Repo \"" + i + "/" + j + "\" does not have a file named \"" + n + "\" in the \"" + G + "\" branch.");
            if (!t.ok)
                throw new Error("Error fetching " + n + ".");
    ...
    function K(n) {
        ...
        return f(h("search/issues?q=" + encodeURIComponent(e) + "&sort=created&order=asc")).then(function(n) {
            ...
            if (0 === t.total_count)
                return null;
            t.total_count > 1 && console.warn("Multiple issues match \"" + e + "\"."),
            n = n.toLowerCase();
            ...
            return console.warn("Issue search results do not contain an issue with title matching \"" + n + "\". Using first result."),
            t.items[0]
        })
    }
    function L(n) {
    ...
    function N(n, e, t, r, $) {
        var o = p + "/repos/" + i + "/" + j + "/issues" + ($ ? "?label=" + encodeURIComponent($) : "")
          , a = new Request(o,{
            method: "POST",
            body: JSON.stringify({
                title: n,
    ...
    b.loadJsonFile = J,
    b.loadIssueByTerm = K,
    b.loadIssueByNumber = L,
    b.loadCommentsPage = w,
    b.loadUser = M,
    b.createIssue = N,
    b.postComment = O,
    b.toggleReaction = P,
    ...
    function ka(r, e) {
        ...
        if ($ < 5e3)
            return "just now";
        for (var o = 0; o + 2 < n.length && 1.1 * $ > n[o + 2]; )
            o += 2;
        var t = n[o]
          , a = n[o + 1]
          , h = Math.round($ / t);
    ...
    function A(e, t) {
        var n = function(t) {
            return z(e, t, !1, 0) + "<span class=\"reaction-name\" aria-hidden=\"true\">" + s[t] + "</span>"
        };
    ...
    e.getReactionHtml = z,
    e.enableReactions = S,
    e.getReactionsMenuHtml = A,
    e.getSignInToReactMenuHtml = B;
    ...
    var sa = "?v=3&s=88"
      ...
      , ua = function() {
        function e(e, r, t) {
            ...
            n.login === r && this.element.classList.add("current-user");
            var l = ta[s]
              , m = v.reduce(function(e, r) {
                return e + c[r]
            }, 0)
              , $ = ""
              , u = "";
            t || (r ? ($ = A(e.reactions.url, "right"),
            u = A(e.reactions.url, "center")) : ($ = B("right"),
            u = B("center"))),
    ...
    var va = function() {
        ...
        e.prototype.insertComment = function(e, t) {
            var n = new ua(e,this.user ? this.user.login : null,this.issue.locked)
    ...
    var X = l && l.__assign || function() {
      ...
      , wa = l && l.__awaiter || function(t, e, n, r) {
      ...
      , Y = function() {
        function t(t, e) {
            ...
            this.handleInput = function() {
                ...
                e ? n.preview.textContent = u : (n.preview.textContent = "Loading preview...",
            ...
            this.handleClick = function(t) {
                ...
                if (e instanceof HTMLButtonElement && e.classList.contains("tabnav-tab") && "true" !== e.getAttribute("aria-selected")) {
                    ...
                    var r = e.classList.contains("tab-preview");
                    n.textarea.style.display = r ? "none" : "",
                    n.preview.style.display = r ? "" : "none",
                    d()
                }
            }
            ,
            this.handleKeyDown = function(t) {
                var e = t.which
                  , r = t.ctrlKey;
                13 === e && r && !n.submitButton.disabled && n.form.dispatchEvent(new CustomEvent("submit"))
            }
            ,
            this.element = document.createElement("article"),
            this.element.classList.add("timeline-comment"),
        ...
        return t.prototype.setUser = function(t) {
            ...
            this.textarea.placeholder = "Leave a comment") : (this.avatarAnchor.removeAttribute("href"),
    ...
    function Ba(e, t) {
        return new Promise(function(s) {
            ...
            n.onload = s,
            n.href = "/stylesheets/themes/" + e + "/utterances.css",
    ...
    var x = g && g.__awaiter || function(e, r, t, n) {
      ...
      , y = g && g.__generator || function(e, r) {
        var t, n, o, s, i = {
            label: 0,
            sent: function() {
                if (1 & o[0])
    ...
    function Da() {
        return x(this, void 0, void 0, function() {
            ...
            return y(this, function(u) {
                ...
                case 1:
                    return u.sent(),
                    [4, Promise.all([Ca(), M(), Ba(a.theme, a.origin)])];
                case 2:
                    return e = u.sent(),
                    r = e[0],
                    t = e[1],
                    ...
                    o = function(e) {
                        return x(i, void 0, void 0, function() {
                            ...
                            return y(this, function(o) {
                                ...
                                case 1:
                                    return o.sent(),
                                    r ? [3, 3] : [4, N(a.issueTerm, a.url, a.title, a.description || "", a.label)];
                                case 2:
                                    r = o.sent(),
                                    n.setIssue(r),
                                    o.label = 3;
                    ...
                    ,
                    s = new Y(t,o),
                    n.element.appendChild(s.element),
                    [2]);
                }
            })
        })
                        ...
                        if (0 !== $)
                            var o = n.pop()
                              , s = r.insertPageLoader(o, $ * q, function() {
                                return x(c, void 0, void 0, function() {
                                    var r;
